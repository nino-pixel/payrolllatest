...
.employee-details {
  ...
  min-width: 300px;
  background: white;
  color: #660066; /* Base text color for employee details */
...
.summary-item.total .amount {
  color: #ffffff; /* Changed to white for better contrast on gradient background */
...
.generate-btn {
  background: linear-gradient(135deg, #cc66ff, #660066);
  color: #ffffff; /* Explicit white color for button text */
  border: none;
  padding: 15px 40px;
  border-radius: 25px;
  font-size: 1.1em;
