    ...
    computed: {
      filteredPayments() {
        return this.payments.filter(payment => {
          const matchesName = !this.searchQuery || payment.name.toLowerCase().includes(this.searchQuery.toLowerCase())
          const matchesDepartment = !this.departmentFilter || payment.department === this.departmentFilter
          const matchesDate = !this.dateFilter || payment.date.startsWith(this.dateFilter)
